    ...
    <main className="mx-auto max-w-6xl px-4 py-14">
        ...
        <div className="p-6 md:p-10">
          ...
          <div className="mt-2 flex items-center gap-3">
            ...
            <h1 className="text-3xl md:text-4xl font-semibold">
              Fortune-1411 &ndash; Vertrauen, Stärke und Zukunft in einem Investment.
            </h1>
          </div>

          <p className="mt-4 max-w-3xl text-white/70">
            Wir wurden aus einer klaren Vision heraus gegründet: Wohlstand für unsere Partner zu schaffen &ndash;
            gestützt auf Transparenz, Sicherheit und innovative Strategien. Unser Ziel ist es, nachhaltige
            Renditen zu generieren &ndash; mit einem starken Fundament und einem klaren Vorteil für unsere Investoren.
          </p>
      ...
      <section className="mb-12 grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-sm text-white/70">
            Zusammenarbeit mit führenden Investmentfirmen &ndash; inklusive gezieltem Informationsankauf.
          </p>
        </div>
      </section>
      ...
      <section className="mb-12 grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8">
          ...
          <p className="mt-3 text-white/70">
            ...
            System, das Sicherheit, Fairness und Performance verbindet &ndash; ohne unnötige Abhängigkeiten.
          </p>
          <p className="mt-3 text-white/70">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 md:p-8">
          ...
          <p className="mt-3 text-white/70">
            ...
            ausschütten.&quot;</em> Dieser Vorteil fließt direkt in die Rendite unserer Partner &ndash; transparent und nachvollziehbar.
          </p>
          <ul className="mt-4 list-disc pl-5 text-white/70 space-y-2">
            ...
            <li>Langfristige Ausrichtung &ndash; wir profitieren, wenn unsere Investoren profitieren.</li>
          </ul>
        </div>
      </section>
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-white/10 p-4">
            ...
            <p className="mt-1 text-white/80">
              Kein Single-Point-of-Failure &ndash; Zugang zu globalen Märkten und Informationen.
            </p>
          </div>
          <div className="rounded-xl border border-white/10 p-4">
            <p className="text-sm text-white/60">Partnerorientiert</p>
            <p className="mt-1 text-white/80">
              Wir denken in Zyklen, nicht in Quartalen &ndash; Stabilität vor kurzfristiger Volatilität.
            </p>
          </div>
          <div className="rounded-xl border border-white/10 p-4">
            <p className="text-sm text-white/60">Informationsvorsprung</p>
            <p className="mt-1 text-white/80">
              Daten, Research und Netzwerke liefern uns Edge &ndash; wir investieren auch in Wissen.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-white/10 bg-gradient-to-br from-emerald-600/20 via-white/5 to-white/5 p-8 md:p-10">
        ...
        <p className="mt-3 max-w-3xl text-white/70">
          Unser Versprechen: Verlässlichkeit, Transparenz und eine klare Vision &ndash; Wohlstand durch Gemeinschaft,
